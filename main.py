...
def createModel2(model_name, train_x, train_y, val_x, val_y, epochs, timesteps, batch_size, prediction_length, features=1):
    ...
    filepath="C:\Dropbox\Bc\Python Projects\\bc_checkpoints\\bestcheckpoint" + model_name + ".h5"
...
if __name__ == '__main__':
    ...
    epochs = 20
    total_epochs = 50
    model_name = '{0}e_model(48, 48, 48, 96)_shape({1}, {2}, {3})_drop1_val5_days2_weather2'.format(total_epochs, batch_size, timesteps, features)
    # !!! UPDATE THIS BEFORE SAVING THE MODEL !!!
    ...
    ''' optional: Load '''
    model = load_model('30e_model(48, 48, 48, 96)_shape(384, 672, 5)_drop1_val5_days2_weather2.h5')
    print("Model Loaded!")
